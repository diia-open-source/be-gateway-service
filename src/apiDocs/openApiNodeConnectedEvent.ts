...
import type { BrokerNode, Context, Service, ServiceEvents } from 'moleculer'
...
export default (config: Partial<AppConfig>, routesBuilder: RoutesBuilder, openApiGenerator: OpenApiGenerator): ServiceEvents => ({
    '$node.connected': {
