...
export default class NotificationTemplateCreateEventListener implements EventBusListener {
    constructor(
    ...
    readonly event: ExternalEvent = ExternalEvent.NotificationTemplateCreate
