...
This repository contains the service which provides HTTP gateway functionality and exposes API endpoints.
...
In order to install and use the linked dependencies for `gateway-service` the following command can be used:
